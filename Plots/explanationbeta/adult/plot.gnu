...
plot 'explanation0.7/data.txt' using ($2):xtic(1) t "age <= 40 and pay <= 50K" lw 4 lc 1 lt 1, '' u ($3) t"" lw 4 lc 2 lt 1,  '' u ($4) t"" lw 4 lc 3 lt 1,  '' u ($5) t"" lw 4 lc 4 lt 1
...
plot 'explanation0.8/data.txt' using ($2):xtic(1) t"" lw 4 lc 1 lt 1, '' u ($3) t"age <= 40 and pay >50K" lw 4 lc 2 lt 1,  '' u ($4) t"" lw 4 lc 3 lt 1,  '' u ($5) t"" lw 4 lc 4 lt 1
...
plot 'explanation0.9/data.txt' using ($2):xtic(1) t"" lw 4 lc 1 lt 1, '' u ($3) t"" lw 4 lc 2 lt 1,  '' u ($4) t"age >40 and pay <=50K" lw 4 lc 3 lt 1,  '' u ($5) t"" lw 4 lc 4 lt 1
...
plot 'explanation1/data.txt' using ($2):xtic(1) t"" lw 4 lc 1 lt 1, '' u ($3) t"" lw 4 lc 2 lt 1,  '' u ($4) t"" lw 4 lc 3 lt 1,  '' u ($5) t"age >40 and pay >50K" lw 4 lc 4 lt 1
